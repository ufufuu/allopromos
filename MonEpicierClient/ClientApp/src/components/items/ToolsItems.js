...
class ToolsItems extends React.Component
{
	...
	return(
		...
		{
			this.props.mystores.map((item)=>(
				<div className="col-md-4" style={{backgroundColor:'#e2e2e2', 'border':'1px dashed', 
					display:'inline'}}>
						<div style={{border:'1px dotted red'}}>
							<div style={{width:'auto'}}>
								<div style={{border:'1px dotted blue', width:'auto', 
									backgroundColor:'#000', color:'#fff'}}><h5>{item.StoreName}</h5>
								</div>
							</div>
