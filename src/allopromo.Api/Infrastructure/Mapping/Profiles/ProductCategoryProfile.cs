...
namespace allopromo.Api.Infrastructure.AutoMapper.Profiles
{
    public class ProductCategoryProfile : Profile
    {
        ...
        {
            this.CreateMap<ProductCategory, ProductCategoryDto>().ForMember<string>((Expression<Func<ProductCategoryDto, string>>)(x => x.categoryName), (Action<IMemberConfigurationExpression<ProductCategory, ProductCategoryDto, string>>)(m => m.MapFrom<string>((Expression<Func<ProductCategory, string>>)(p => p.productCategoryName))));
