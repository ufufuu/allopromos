...
namespace allopromo.Admin.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(IHttpClientFactory httpClientFactory, ILogger<HomeController> logger)
        {
        ...
        public async Task<IActionResult> Orders(UserDto userDto)
        {
            HttpResponseMessage responseMessage = null;
            if (userDto != null)
            {
        ...
        //GET manage/stores/categories
        [HttpGet]
        public async Task<IActionResult> CreateStoreCategory()
        {
            return View();
        }
        //POST manage/stores/category/create
        [HttpPost]
        public async Task<IActionResult> PostCreateStore(StoreCategoryDto categoryDto)
        {
            string requestUrl = "category/create";
            ...
            using(var httpClient = new HttpClient())
            {
                httpClient.BaseAddress = new Uri("http://localhost:44367/api");
                var httpResponse = httpClient.PostAsync(requestUrl, jsonStringObj);
                {
